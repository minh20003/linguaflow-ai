...
export const MessageAttachmentCard: React.FC<MessageAttachmentCardProps> = ({
  ...
  }, [attachment, isImage, onLoadPreview]);
  ...
  return (
    <article className="w-[min(21rem,72vw)] overflow-hidden rounded-xl border border-[#DDE1EA] bg-white text-[#1E2230] shadow-sm dark:border-[#34394A] dark:bg-[#232630] dark:text-[#F5F6FA]">
      ...
      >
        <span className={`flex h-10 w-10 flex-none items-center justify-center rounded-lg ${isImage ? 'bg-violet-50 text-violet-600 dark:bg-violet-500/15 dark:text-violet-300' : 'bg-[#EFF6FF] text-[#2563EB] dark:bg-[#2563EB]/20 dark:text-[#60A5FA]'}`}>
