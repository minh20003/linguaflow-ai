...
# a schema-compliant answer.  Keep translation responsive at its configured
# timeout while giving this explicitly requested interaction a bounded window.
_CLARIFICATION_TIMEOUT_FLOOR_SECONDS = 30.0
